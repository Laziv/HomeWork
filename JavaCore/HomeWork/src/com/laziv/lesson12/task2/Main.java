        ...
        switch (numOfSelect) {
            ...
            case 6:
                ...
                try {
                    ...
                    if (index == seasonsList.size() - 1)
                        index = -1;
                    System.out.println("Next season is " + seasonsList.get(index - 1));
                } catch (WrongInputConsoleParametersException e) {
                    System.out.println(e.getMessage());
                }
            ...
            case 7:
                ...
                try {
                    ...
                    if (index == -1) {
                        index = seasonsList.size() - 1;
                    }
                    System.out.println("Previous season was " + seasonsList.get(index));
                } catch (WrongInputConsoleParametersException e) {
                    System.out.println(e.getMessage());
                }
